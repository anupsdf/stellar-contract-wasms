(module
  ...
  (export "mint" (func 26))
  (export "check" (func 29))
  (export "add_minter" (func 30))
  (export "remove_minter" (func 31))
  (export "transfer_from" (func 32))
  (export "owner_of" (func 33))
  (export "set_base_uri" (func 34))
  (export "get_base_uri" (func 35))
  (export "get_token_uri" (func 37))
  (export "_" (func 39))
  ...
  (func (;27;) (type 13) (param i64 i64 i64) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 48
    i32.sub
