(module
  ...
  (global (;1;) i32 i32.const 1048970)
  (global (;2;) i32 i32.const 1048976)
  (export "memory" (memory 0))
  (export "__constructor" (func 22))
  (export "set_value" (func 29))
  (export "get_value" (func 37))
  (export "get_value_updated_at" (func 38))
  (export "commit_transfer_ownership" (func 40))
  (export "apply_transfer_ownership" (func 45))
  (export "revert_transfer_ownership" (func 46))
  (export "get_future_address" (func 48))
  (export "version" (func 52))
  (export "commit_upgrade" (func 53))
  (export "apply_upgrade" (func 59))
  (export "revert_upgrade" (func 61))
  (export "set_emergency_mode" (func 62))
  (export "get_emergency_mode" (func 64))
  (export "_" (func 70))
  ...
  (func (;70;) (type 9))
  (data (;0;) (i32.const 1048576) "commit_transfer_ownershipapply_transfer_ownershiprevert_transfer_ownershipdisable_emergency_modeenable_emergency_modeAdminEmergencyAdminRewardsAdminOperationsAdminPauseAdminEmergencyPauseAdminSystemFeeAdminOperatorEmPauseAdminsFutureAdminFutureEmergencyAdminTransferOwnershipDeadlineEmAdminTransferOwnershipDeadlineEmergencyModecommit_upgradeapply_upgraderevert_upgradeUpgradeDeadlineFutureWASM")
