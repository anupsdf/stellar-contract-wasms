(module
  ...
  (func (;77;) (type 23) (param i64) (result i32)
    local.get 0
    i32.const 1048782
    i32.const 5
    call 51
  ...
  (func (;81;) (type 11) (param i32) (result i32)
    (local i32)
    i32.const 7
    local.set 1
    block ;; label = @1
  ...
  (func (;92;) (type 11) (param i32) (result i32)
    (local i32 i64)
    local.get 0
    i64.load
    local.set 2
  ...
  (data (;0;) (i32.const 1048576) "checkpoint_rewardcheckpoint_working_balanceAllowancefromspender\004\00\10\00\04\00\00\008\00\10\00\07\00\00\00amountexpiration_ledger\00P\00\10\00\06\00\00\00V\00\10\00\11\00\00\00BalanceTokencommit_transfer_ownershipapply_transfer_ownershiprevert_transfer_ownershipAdminEmergencyAdminRewardsAdminOperationsAdminPauseAdminEmergencyPauseAdminSystemFeeAdminOperatorEmPauseAdminsFutureAdminFutureEmergencyAdminTransferOwnershipDeadlineEmAdminTransferOwnershipDeadlineapprovedecimalnamesymbol\9b\01\10\00\07\00\00\00\a2\01\10\00\04\00\00\00\a6\01\10\00\06")
