(module
  ...
  (elem (;0;) (i32.const 1) func 75 74 49 76)
  ...
  (func (;72;) (type 20) (param i32 i32 i32 i32) (result i32)
    (local i32)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
  ...
  (func (;88;) (type 22) (param i32 i64 i64 i64 i64 i32)
