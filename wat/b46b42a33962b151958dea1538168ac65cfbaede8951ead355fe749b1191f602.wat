(module $exp_wrapper_contract.wasm
  ...
  (import "x" "1" (func $_ZN17soroban_env_guest5guest7context14contract_event17hb324a246fdd4c4a3E (;11;) (type 0)))
  (import "l" "_" (func $_ZN17soroban_env_guest5guest6ledger17put_contract_data17h2f0a6664ce1b4693E (;12;) (type 2)))
  (import "a" "0" (func $_ZN17soroban_env_guest5guest7address12require_auth17h65f7b10e530438b0E (;13;) (type 3)))
  (import "i" "_" (func $_ZN17soroban_env_guest5guest3int12obj_from_u6417h45c978116a778f72E (;14;) (type 3)))
  (table (;0;) 1 1 funcref)
  (memory (;0;) 17)
  ...
  (func $open (;15;) (type 4) (param i64 i64 i64 i64 i64) (result i64)
  ...
  (func $close (;16;) (type 0) (param i64 i64) (result i64)
  ...
  (func $_ZN70_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..Env$GT$16obj_to_i128_lo6417h4ca823de1b578bd2E (;17;) (type 5) (param i32 i64) (result i64)
    local.get 0
    local.get 1
  ...
  (func $_ZN70_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..Env$GT$20obj_from_i128_pieces17h5d07ce5cd81eff9dE (;18;) (type 6) (param i32 i64 i64) (result i64)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_ZN74_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..EnvBase$GT$19map_new_from_slices17h123f335ffd2606d2E (;19;) (type 7) (param i32 i32 i32 i32 i32) (result i64)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
  ...
  (func $_ZN70_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..Env$GT$16obj_to_i128_hi6417hce04b17038db4610E (;20;) (type 5) (param i32 i64) (result i64)
    local.get 0
    local.get 1
  ...
  (func $_ZN70_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..Env$GT$4call17h46b706d0a28ccc2bE (;21;) (type 8) (param i32 i64 i64 i64) (result i64)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
  ...
  (func $_ZN74_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..EnvBase$GT$19map_unpack_to_slice17h4854fee04c368cdfE (;22;) (type 9) (param i32 i64 i32 i32 i32 i32) (result i64)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
  ...
  (func $_ZN74_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..EnvBase$GT$18vec_new_from_slice17hfaedeb666694b5f6E (;23;) (type 10) (param i32 i32 i32) (result i64)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_ZN70_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..Env$GT$17put_contract_data17hca5c37a40fa3b863E (;24;) (type 8) (param i32 i64 i64 i64) (result i64)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
  ...
  (func $_ZN70_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..Env$GT$14contract_event17h5fa17caaabb6e76fE (;25;) (type 6) (param i32 i64 i64) (result i64)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_ZN70_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..Env$GT$12obj_from_u6417h164bc3ae2638e19eE (;26;) (type 5) (param i32 i64) (result i64)
    local.get 0
    local.get 1
    call $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$12obj_from_u6417h7427a8ff564c6bbaE
  )
  (func $_ZN70_$LT$soroban_sdk..env..Env$u20$as$u20$soroban_env_common..env..Env$GT$10obj_to_u6417h8217dd72b4605177E (;27;) (type 5) (param i32 i64) (result i64)
    local.get 0
    local.get 1
    call $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$10obj_to_u6417h666f92e637feecd7E
  )
  (func $_ZN11soroban_sdk7address7Address12require_auth17h8beae2e6e80ef619E (;28;) (type 11) (param i32)
    local.get 0
    i32.const 8
    i32.add
    local.get 0
  ...
  (func $_ZN11soroban_sdk7address7Address21require_auth_for_args17hb68ef65138791df9E (;29;) (type 12) (param i32 i64)
    local.get 0
    i32.const 8
    i32.add
    local.get 0
  ...
  (func $_ (;30;) (type 13))
  (func $_ZN11soroban_sdk7storage7Storage12get_internal17hc49c37ef1585eadeE (;31;) (type 6) (param i32 i64 i64) (result i64)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_ZN11soroban_sdk7storage7Storage12has_internal17hb25fc9d406e744b5E (;32;) (type 14) (param i32 i64 i64) (result i32)
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$17has_contract_data17h5bd0f60bd5b9ae74E (;33;) (type 6) (param i32 i64 i64) (result i64)
    local.get 1
    local.get 2
    call $_ZN17soroban_env_guest5guest6ledger17has_contract_data17h74118057ca54318cE
  )
  (func $_ZN84_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..EnvBase$GT$19map_unpack_to_slice17h100f5982e25683e6E (;34;) (type 9) (param i32 i64 i32 i32 i32 i32) (result i64)
    block ;; label = @1
      local.get 3
      local.get 5
      i32.eq
  ...
  (func $_ZN84_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..EnvBase$GT$18vec_new_from_slice17h7e82145705d7faccE (;35;) (type 10) (param i32 i32 i32) (result i64)
    local.get 1
    i64.extend_i32_u
    i64.const 32
    i64.shl
  ...
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$20obj_from_i128_pieces17hcbe6af3fc7c28b37E (;36;) (type 6) (param i32 i64 i64) (result i64)
    local.get 1
    local.get 2
    call $_ZN17soroban_env_guest5guest3int20obj_from_i128_pieces17h3202438d4592cbb3E
  )
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$16obj_to_i128_lo6417hf5ef4ca8c341173aE (;37;) (type 5) (param i32 i64) (result i64)
    local.get 1
    call $_ZN17soroban_env_guest5guest3int16obj_to_i128_lo6417hcc6575a4afb675f8E
  )
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$16obj_to_i128_hi6417h533e7d3123720294E (;38;) (type 5) (param i32 i64) (result i64)
    local.get 1
    call $_ZN17soroban_env_guest5guest3int16obj_to_i128_hi6417ha56ca73e0af254c0E
  )
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$4call17ha3f819a6c8a10883E (;39;) (type 8) (param i32 i64 i64 i64) (result i64)
    local.get 1
    local.get 2
    local.get 3
    call $_ZN17soroban_env_guest5guest4call4call17he49ba8a03d494d3eE
  )
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$17get_contract_data17h1237e2ee122edc26E (;40;) (type 6) (param i32 i64 i64) (result i64)
    local.get 1
    local.get 2
    call $_ZN17soroban_env_guest5guest6ledger17get_contract_data17ha2384d3bf2dd9eaaE
  )
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$21require_auth_for_args17h30ee5e486e719022E (;41;) (type 6) (param i32 i64 i64) (result i64)
    local.get 1
    local.get 2
    call $_ZN17soroban_env_guest5guest7address21require_auth_for_args17h84b6e8abd84f7d0dE
  )
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$10obj_to_u6417h666f92e637feecd7E (;42;) (type 5) (param i32 i64) (result i64)
    local.get 1
    call $_ZN17soroban_env_guest5guest3int10obj_to_u6417hc5a26d1c99c622f6E
  )
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$14contract_event17he413fd8a721e3b3bE (;43;) (type 6) (param i32 i64 i64) (result i64)
    local.get 1
    local.get 2
    call $_ZN17soroban_env_guest5guest7context14contract_event17hb324a246fdd4c4a3E
  )
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$17put_contract_data17ha97c84a624cfc624E (;44;) (type 8) (param i32 i64 i64 i64) (result i64)
    local.get 1
    local.get 2
    local.get 3
    call $_ZN17soroban_env_guest5guest6ledger17put_contract_data17h2f0a6664ce1b4693E
  )
  (func $_ZN84_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..EnvBase$GT$19map_new_from_slices17he01a2b7ba3f5a20dE (;45;) (type 7) (param i32 i32 i32 i32 i32) (result i64)
    block ;; label = @1
      local.get 2
      local.get 4
      i32.eq
  ...
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$12require_auth17he6b5fc695f031d25E (;46;) (type 5) (param i32 i64) (result i64)
    local.get 1
    call $_ZN17soroban_env_guest5guest7address12require_auth17h65f7b10e530438b0E
  )
  (func $_ZN80_$LT$soroban_env_guest..guest..Guest$u20$as$u20$soroban_env_common..env..Env$GT$12obj_from_u6417h7427a8ff564c6bbaE (;47;) (type 5) (param i32 i64) (result i64)
    local.get 1
