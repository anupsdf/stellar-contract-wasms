(module
  ...
  (type (;21;) (func (param i32 i32 i32 i64 i64 i64 i32) (result i32)))
  ...
  (export "deploy" (func 62))
  (export "initialize_escrow" (func 64))
  (export "fund_escrow" (func 65))
  (export "release_funds" (func 66))
  (export "update_escrow" (func 69))
  (export "get_escrow" (func 70))
  (export "get_escrow_by_contract_id" (func 71))
  (export "get_multiple_escrow_balances" (func 72))
  (export "extend_contract_ttl" (func 74))
  (export "change_milestone_status" (func 75))
  (export "approve_milestone" (func 76))
  (export "resolve_dispute" (func 77))
  (export "dispute_escrow" (func 78))
  (export "_" (global 1))
  ...
  (func (;59;) (type 21) (param i32 i32 i32 i64 i64 i64 i32) (result i32)
  ...
  (func (;60;) (type 12) (param i32 i32) (result i32)
    (local i32)
    block ;; label = @1
      local.get 0
      i64.load
      ...
      block ;; label = @2
        block ;; label = @3
          ...
          if ;; label = @4
            ...
            i32.store16 offset=541 align=1
            local.get 2
            local.get 9
  ...
  (func (;80;) (type 13) (param i32 i32 i32) (result i32)
  ...
  (func (;86;) (type 8) (param i32 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
