(module
  ...
  (func (;73;) (type 12) (param i32 i32 i64)
    local.get 0
    call 58
    local.get 1
    i64.extend_i32_u
  ...
  (func (;116;) (type 21) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      local.get 3
      i32.const 64
