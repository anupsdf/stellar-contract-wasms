(module
  ...
  (export "update" (func 36))
  (export "resolve" (func 37))
  (export "upgrade" (func 43))
  (export "__check_auth" (func 45))
  (export "_" (func 46))
  ...
  (func (;34;) (type 13) (param i32 i32) (result i32)
    local.get 1
    i32.load offset=28
    i32.const 1048803
    i32.const 15
  ...
  (func (;35;) (type 8) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
    local.get 0
    i64.const 255
    i64.and
    i64.const 77
  ...
  (func (;36;) (type 8) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
