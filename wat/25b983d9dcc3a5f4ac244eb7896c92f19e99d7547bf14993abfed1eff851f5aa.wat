(module
  ...
  (elem (;0;) (i32.const 1) func 69 68 35 70)
  ...
  (func (;42;) (type 18) (param i64 i64 i32)
    (local i32 i64)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;63;) (type 20) (param i32 i64 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;76;) (type 22) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      local.get 3
      i32.const 64
  ...
  (func (;79;) (type 24) (param i64 i32) (result i64)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
