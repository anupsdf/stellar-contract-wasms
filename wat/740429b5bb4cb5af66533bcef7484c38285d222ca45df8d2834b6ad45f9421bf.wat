(module
  ...
  (export "init" (func 50))
  (export "keeper" (func 55))
  (export "claim_fee" (func 60))
  ...
  (func (;45;) (type 17) (param i64 i64) (result i32)
    local.get 0
    local.get 1
    call 27
    i64.const 1
  ...
  (func (;48;) (type 18) (param i64 i32 i32)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;68;) (type 20) (param i64 i32) (result i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;75;) (type 12) (param i64 i64 i64 i64 i64)
    local.get 0
    local.get 1
    call 53
    local.get 2
  ...
  (func (;77;) (type 22) (param i32 i64 i64 i64 i64 i32)
  ...
  (func (;78;) (type 23) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      local.get 3
      i32.const 64
  ...
  (func (;79;) (type 9) (param i32 i64 i64 i64 i64)
  ...
  (data (;2;) (i32.const 1048928) "argscontractfn_name\00`\01\10\00\04\00\00\00d\01\10\00\08\00\00\00l\01\10\00\07\00\00\00executablesalt\00\00\8c\01\10\00\0a\00\00\00\96\01\10\00\04\00\00\00Wasmcontextsub_invocations\00\00\b0\01\10\00\07\00\00\00\b7\01\10\00\0f\00\00\00DepositTokenSharesTotSupplyLeeWay")
