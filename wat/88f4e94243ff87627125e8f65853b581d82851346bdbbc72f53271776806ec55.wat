(module
  ...
  (func (;70;) (type 4) (param i32) (result i64)
    (local i32 i64 i64 i64 i64 i64)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;86;) (type 5) (param i64 i64 i32)
    block ;; label = @1
      block ;; label = @2
        local.get 2
        i32.eqz
  ...
  (func (;89;) (type 29) (param i32 i32 i32 i32) (result i64)
    local.get 1
    local.get 3
    i32.ne
    if ;; label = @1
  ...
  (func (;103;) (type 30) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
  ...
  (func (;114;) (type 32) (param i32 i64 i64 i64 i64)
