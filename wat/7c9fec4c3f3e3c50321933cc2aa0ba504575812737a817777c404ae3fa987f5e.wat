(module
  ...
  (export "distribute_payout" (func 61))
  (export "distribute_payouts" (func 63))
  (export "migrate_data_to_persistent" (func 64))
  (export "_" (func 66))
