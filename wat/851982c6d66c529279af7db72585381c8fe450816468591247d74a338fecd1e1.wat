(module
  ...
  (func (;22;) (type 15) (param i32) (result i64)
    local.get 0
    i32.const 1
    call 59
  )
  ...
  (func (;35;) (type 18) (param i32 i32 i32 i32) (result i64)
    local.get 1
    local.get 3
    i32.ne
    if ;; label = @1
