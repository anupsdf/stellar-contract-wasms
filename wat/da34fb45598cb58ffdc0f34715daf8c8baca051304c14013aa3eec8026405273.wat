(module
  ...
  (export "set_swap_fee_contract_wasm" (func 36))
  (export "deploy_swap_fee_contract" (func 40))
  (export "version" (func 42))
  (export "commit_upgrade" (func 43))
  ...
  (export "apply_transfer_ownership" (func 59))
  (export "revert_transfer_ownership" (func 60))
  (export "get_future_address" (func 62))
  (export "_" (func 72))
  ...
  (func (;54;) (type 8) (param i64 i64 i64) (result i64)
    (local i32)
    block ;; label = @1
      local.get 0
      i64.const 255
  ...
  (func (;69;) (type 7) (param i32) (result i32)
    (local i32)
    i32.const 9
    local.set 1
    block ;; label = @1
  ...
  (func (;70;) (type 7) (param i32) (result i32)
    (local i32 i64)
    local.get 0
    i64.load
    local.set 2
