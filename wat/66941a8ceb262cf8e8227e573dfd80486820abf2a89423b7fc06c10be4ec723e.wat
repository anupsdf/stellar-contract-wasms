(module
  ...
  (func (;21;) (type 12) (param i32 i32 i32 i32) (result i64)
    local.get 1
    local.get 3
    i32.ne
    if ;; label = @1
  ...
  (func (;30;) (type 10) (param i64 i64 i64 i64)
  ...
  (func (;31;) (type 5) (param i64 i64 i64)
    (local i32 i64)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;53;) (type 5) (param i64 i64 i64)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (data (;1;) (i32.const 1048624) "attempt to add with overflowAllowancefromspenderU\00\10\00\04\00\00\00Y\00\10\00\07\00\00\00amountexpiration_ledger\00p\00\10\00\06\00\00\00v\00\10\00\11\00\00\00BalanceAdmincalled `Option::unwrap()` on a `None` valueapprovedecimalnamesymbol\00\d6\00\10\00\07\00\00\00\dd\00\10\00\04\00\00\00\e1\00\10\00\06")
