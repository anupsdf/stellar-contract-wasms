(module
  ...
  (global (;1;) i32 i32.const 1049011)
  ...
  (export "contract_name" (func 57))
  (export "commit_upgrade" (func 58))
  (export "apply_upgrade" (func 64))
  (export "revert_upgrade" (func 66))
  (export "set_emergency_mode" (func 67))
  (export "get_emergency_mode" (func 69))
  (export "_" (func 77))
  ...
  (func (;73;) (type 16) (param i64 i64) (result i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;77;) (type 10))
  (data (;0;) (i32.const 1048576) "TotalSupplyLockerFeedcommit_transfer_ownershipapply_transfer_ownershiprevert_transfer_ownershipset_privileged_addrsdisable_emergency_modeenable_emergency_modeAdminEmergencyAdminRewardsAdminOperationsAdminPauseAdminEmergencyPauseAdminSystemFeeAdminOperatorEmPauseAdminsFutureAdminFutureEmergencyAdminTransferOwnershipDeadlineEmAdminTransferOwnershipDeadlineEmergencyModecommit_upgradeapply_upgraderevert_upgradeUpgradeDeadlineFutureWASM")
