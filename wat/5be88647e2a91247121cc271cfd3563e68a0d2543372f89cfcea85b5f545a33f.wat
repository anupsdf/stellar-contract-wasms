(module
  ...
  (export "commit_upgrade" (func 66))
  (export "apply_upgrade" (func 73))
  (export "revert_upgrade" (func 75))
  (export "set_emergency_mode" (func 76))
  (export "get_emergency_mode" (func 78))
  (export "commit_transfer_ownership" (func 79))
  (export "apply_transfer_ownership" (func 87))
  ...
  (data (;0;) (i32.const 1048576) "Planecommit_transfer_ownershipapply_transfer_ownershiprevert_transfer_ownershipdisable_emergency_modeenable_emergency_modeAdminEmergencyAdminRewardsAdminOperationsAdminPauseAdminEmergencyPauseAdminSystemFeeAdminOperatorEmPauseAdminsFutureAdminFutureEmergencyAdminTransferOwnershipDeadlineEmAdminTransferOwnershipDeadlineEmergencyMode")
  (data (;1;) (i32.const 1048925) "commit_upgradeapply_upgraderevert_upgradeUpgradeDeadlineFutureWASM")
