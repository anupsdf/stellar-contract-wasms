(module
  ...
  (import "x" "3" (func (;40;) (type 2)))
  (import "x" "8" (func (;41;) (type 2)))
  ...
  (export "maintains" (func 80))
  (export "change_admin" (func 81))
  (export "add_operator" (func 82))
  (export "remove_operator" (func 83))
  (export "deposit_lp" (func 84))
  (export "deposit_2_lp" (func 86))
  ...
  (func (;64;) (type 19) (param i64 i64) (result i32)
    local.get 0
    local.get 1
    call 42
    i64.const 1
  ...
  (func (;68;) (type 20) (param i32 i64 i64 i64 i64 i64)
    (local i32 i32 i64 i64 i64)
    global.get 0
    i32.const 80
    i32.sub
  ...
  (func (;73;) (type 22) (param i32 i64 i64 i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;91;) (type 25) (param i64 i32 i32)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
