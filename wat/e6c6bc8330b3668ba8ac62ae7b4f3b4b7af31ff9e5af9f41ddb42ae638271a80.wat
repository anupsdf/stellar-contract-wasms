(module
  ...
  (import "v" "h" (func (;12;) (type 1)))
  (import "v" "3" (func (;13;) (type 2)))
  (import "b" "m" (func (;14;) (type 1)))
  ...
  (export "init" (func 49))
  (export "update_xasset_wasm_hash" (func 50))
  (export "deploy_asset_contract" (func 51))
  (export "get_asset_contract" (func 53))
  (export "set_asset_contract" (func 54))
  (export "set_existing_asset_contract" (func 55))
  (export "upgrade_existing_asset_contract" (func 56))
  (export "_" (func 60))
  ...
  (func (;52;) (type 17) (param i32 i64 i64 i64)
    (local i32 i32)
    block ;; label = @1
      block ;; label = @2
        local.get 1
  ...
  (func (;59;) (type 19) (param i32 i32) (result i32)
    block ;; label = @1
      local.get 1
      local.get 0
      i32.lt_u
