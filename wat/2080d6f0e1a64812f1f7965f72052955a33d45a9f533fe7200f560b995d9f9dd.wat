(module
  ...
  (export "init_admin" (func 19))
  (export "version" (func 25))
  (export "commit_upgrade" (func 26))
  (export "apply_upgrade" (func 37))
  (export "revert_upgrade" (func 41))
  (export "set_emergency_mode" (func 42))
  (export "get_emergency_mode" (func 44))
  ...
  (func (;39;) (type 11) (param i64) (result i32)
    local.get 0
    i64.const 2
    call 12
    i64.const 1
