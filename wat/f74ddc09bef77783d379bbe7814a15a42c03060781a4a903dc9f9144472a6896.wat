(module
  ...
  (export "verify_protocols" (func 64))
  (export "get_protocols" (func 65))
  (export "verify_protocols_unordered" (func 67))
  (export "handle_call_message" (func 68))
  (export "verify_protocol_recovery" (func 70))
  (export "get_modified_protocols" (func 72))
  ...
  (elem (;0;) (i32.const 1) func 39 44 39 76 39 79 111 110 39 107)
  ...
  (func (;108;) (type 21) (param i32 i32 i32 i32)
    (local i32)
    global.get 0
    i32.const -64
    i32.add
