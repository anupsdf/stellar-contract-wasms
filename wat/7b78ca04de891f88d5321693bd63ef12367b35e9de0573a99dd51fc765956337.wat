(module
  ...
  (export "trade" (func 47))
  (export "__constructor" (func 53))
  (export "upgrade" (func 54))
  (export "add_vegetables" (func 55))
  (export "remove_vegetables" (func 57))
  (export "grow_shelf_space" (func 58))
  (export "shrink_shelf_space" (func 59))
  (export "open" (func 60))
  ...
  (func (;47;) (type 19) (param i64 i64 i64 i64) (result i64)
  ...
  (func (;50;) (type 20) (param i64 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;63;) (type 14))
  (data (;0;) (i32.const 1048576) "\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00OwnerKaleAddressVegetablesMaxVegetablesIsOpen\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00called `Result::unwrap()` on an `Err` valueConversionError")
