(module
  ...
  (export "get_task_reward" (func 56))
  (export "get_remaining_reward" (func 57))
  (export "campaign_data" (func 58))
  (export "transfer_remaining_funds" (func 59))
  (export "extend_duration" (func 60))
  (export "toggle_freeze" (func 61))
  (export "claim_fees" (func 63))
  (export "set_fee_percentage" (func 64))
  (export "get_collected_fees_public" (func 65))
  (export "_" (global 1))
  ...
  (func (;45;) (type 15) (param i32 i64) (result i64)
    (local i32 i64)
    global.get 0
    i32.const 32
    i32.sub
