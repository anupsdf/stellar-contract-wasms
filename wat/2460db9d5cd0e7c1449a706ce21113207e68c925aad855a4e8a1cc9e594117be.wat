(module
  ...
  (func (;31;) (type 16) (param i64 i64 i64 i64 i32)
    (local i32 i32)
    global.get 0
    i32.const 80
    i32.sub
  ...
  (func (;52;) (type 2) (param i64 i64 i64 i64) (result i64)
    (local i32 i64 i64)
    global.get 0
    i32.const 64
    i32.sub
  ...
  (func (;55;) (type 17) (param i64 i64 i64 i64)
    (local i32)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;64;) (type 11))
  (data (;0;) (i32.const 1048576) "STELLAR MULLER TOKENSMTGCREO3OEYOYWU4FTSOJAEC6EY7OTSQ7H2UJZ5A7YRCYV7R7MTP3JC72Ufromspender\00\00O\00\10\00\04\00\00\00S\00\10\00\07\00\00\00amountexpiration_ledger\00l\00\10\00\06\00\00\00r\00\10\00\11\00\00\00AllowanceBalanceStateAdmincalled `Option::unwrap()` on a `None` valueapprovedecimalnamesymbol\00\00\00\e0\00\10\00\07\00\00\00\e7\00\10\00\04\00\00\00\eb\00\10\00\06\00\00\00")
