(module
  ...
  (func (;40;) (type 8) (param i64 i64 i64 i64 i64 i64 i64 i64 i64) (result i64)
    local.get 0
    i64.const 255
    i64.and
    i64.const 77
  ...
  (func (;41;) (type 8) (param i64 i64 i64 i64 i64 i64 i64 i64 i64) (result i64)
  ...
  (func (;51;) (type 17))
  (data (;0;) (i32.const 1048576) "Contract\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00claim_emissionsclaim_feesswap_exact_tokens_for_tokensrouter_pair_foradminfee_vault_adminfee_vault_addressaggregator_addressrouter_addressblnd_addressusdc_addressblnd_usdc_addressreserve_token_idstransfer")
  (data (;1;) (i32.const 1048812) "\01\00\00\00\01\00\00\00called `Result::unwrap()` on an `Err` valueConversionErrorargscontractfn_name\00\00\00.\01\10\00\04\00\00\002\01\10\00\08\00\00\00:\01\10\00\07\00\00\00contextsub_invocations\00\00\5c\01\10\00\07\00\00\00c\01\10\00\0f")
