(module
  ...
  (func (;91;) (type 10) (param i32) (result i32)
    (local i32)
    i32.const 8
    local.set 1
    block ;; label = @1
  ...
  (func (;92;) (type 26) (param i32 i32 i32 i32) (result i32)
    block ;; label = @1
      local.get 2
      i32.const 1114112
      i32.eq
  ...
  (func (;101;) (type 27) (param i64 i32 i32)
