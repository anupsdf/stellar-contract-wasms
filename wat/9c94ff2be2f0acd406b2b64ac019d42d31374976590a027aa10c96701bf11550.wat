(module
  ...
  (global (;1;) i32 i32.const 1048673)
  (global (;2;) i32 i32.const 1048688)
  (export "memory" (memory 0))
  (export "deploy_huma_config" (func 14))
  (export "deploy_pool_storage" (func 18))
  (export "deploy_pool_manager" (func 21))
  (export "deploy_pool" (func 22))
  (export "deploy_credit" (func 23))
  (export "deploy_tranche" (func 24))
  (export "_" (func 25))
  (export "deploy_credit_storage" (func 23))
  (export "deploy_credit_manager" (func 23))
  (export "__data_end" (global 1))
  (export "__heap_base" (global 2))
  (func (;12;) (type 7) (param i64 i64 i64 i64 i64) (result i64)
    local.get 0
    call 0
    call 1
    i64.eqz
  ...
  (func (;14;) (type 5) (param i64 i64 i64 i64 i64 i64) (result i64)
    (local i32 i32 i64)
    global.get 0
    i32.const 80
    i32.sub
  ...
  (func (;18;) (type 3) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
  ...
  (func (;21;) (type 3) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
    (local i32 i32 i64)
    global.get 0
    i32.const 128
    i32.sub
  ...
  (func (;23;) (type 5) (param i64 i64 i64 i64 i64 i64) (result i64)
    (local i32 i32 i64)
    global.get 0
    i32.const 128
    i32.sub
  ...
  (data (;1;) (i32.const 1048640) "attempt to subtract with overflow")
