(module
  ...
  (func (;64;) (type 4) (result i64)
    (local i32 i32 i64 i64 i32 i32 i64 i64 i64 i64 i64 i64 i64 i64)
    global.get 0
    i32.const 176
    i32.sub
    local.tee 0
