(module
  ...
  (export "burn_the_extra_kale" (func 58))
  (export "_" (func 59))
  ...
  (func (;49;) (type 11) (param i64 i64 i64 i64) (result i64)
    (local i32 i32)
    block ;; label = @1
      local.get 3
      i64.const 2
