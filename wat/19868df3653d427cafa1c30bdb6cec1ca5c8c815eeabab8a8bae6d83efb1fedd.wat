(module
  ...
  (type (;24;) (func (param i32 i64 i64 i64 i32) (result i32)))
  ...
  (func (;37;) (type 19) (param i64 i32 i32) (result i64)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;44;) (type 21) (param i64) (result i32)
    (local i32 i32 i64)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (func (;74;) (type 24) (param i32 i64 i64 i64 i32) (result i32)
  ...
  (func (;88;) (type 28) (param i32 i32 i32 i32) (result i64)
    local.get 1
    local.get 3
    i32.ne
    if ;; label = @1
  ...
  (func (;99;) (type 30) (param i64 i32 i32)
    local.get 0
    i64.const 4
    local.get 1
    i64.extend_i32_u
  ...
  (func (;104;) (type 12) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    block ;; label = @1
      local.get 2
      i32.eqz
  ...
  (@custom "contractmetav0" (after data) "\00\00\00\00\00\00\00\05rsver\00\00\00\00\00\00\061.81.0\00\00\00\00\00\00\00\00\00\08rssdkver\00\00\00/21.7.3#1f8101942d52a6a93226df840876e6308808c0f4\00")
)
