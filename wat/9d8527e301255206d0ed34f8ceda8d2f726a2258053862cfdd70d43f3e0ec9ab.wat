(module
  ...
  (export "remove_zero_tvl_entries" (func 65))
  (export "_" (func 66))
  ...
  (func (;69;) (type 21) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      block ;; label = @2
        local.get 3
  ...
  (func (;74;) (type 22) (param i32 i64 i64 i64 i64 i32)
