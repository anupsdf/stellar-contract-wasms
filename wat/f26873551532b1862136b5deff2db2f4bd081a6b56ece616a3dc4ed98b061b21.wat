(module
  ...
  (export "mul" (func 21))
  (export "div" (func 22))
  (export "add_op" (func 23))
  (export "get_op" (func 25))
  (export "all_op" (func 26))
  (export "add_last_op" (func 27))
  ...
  (func (;18;) (type 8) (param i32 i32 i32 i64) (result i32)
    (local i32 i32 i64)
    global.get 0
    i32.const 64
    i32.sub
  ...
  (func (;23;) (type 2) (param i64 i64 i64 i64) (result i64)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;28;) (type 12) (param i32 i32 i32 i32 i64 i32)
    (local i32 i64)
    global.get 0
    i32.const 32
    i32.sub
