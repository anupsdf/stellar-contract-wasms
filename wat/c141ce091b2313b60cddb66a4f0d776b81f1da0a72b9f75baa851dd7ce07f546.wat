(module
  ...
  (export "get_entry" (func 58))
  (export "version" (func 59))
  (export "init" (func 60))
  (export "upgrade" (func 61))
  (export "invest" (func 62))
  (export "claim_earnings" (func 63))
  (export "migrate_entries" (func 64))
  (export "reset_index" (func 65))
  (export "remove_zero_tvl_entries" (func 66))
  (export "_" (func 67))
  ...
  (func (;70;) (type 21) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      block ;; label = @2
        local.get 3
