(module
  ...
  (func (;58;) (type 17) (param i64 i64) (result i32)
    local.get 0
    local.get 1
    call 30
    i64.const 1
  ...
  (func (;80;) (type 27) (param i64) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;110;) (type 20) (param i64 i64 i64 i64 i64 i64) (result i64)
