(module
  ...
  (import "b" "6" (func (;5;) (type 1)))
  (import "b" "5" (func (;6;) (type 2)))
  ...
  (export "create_wallet" (func 52))
  (export "publish_wallet_version" (func 54))
  (export "get_all_versions" (func 55))
  (export "add_supported_platform" (func 56))
  (export "get_is_smart_wallet" (func 57))
  (export "get_is_smart_wallet_no_return" (func 58))
  (export "get_wallet_by_username" (func 59))
  (export "get_wallet_by_passkey" (func 60))
  ...
  (func (;47;) (type 14) (param i64) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
