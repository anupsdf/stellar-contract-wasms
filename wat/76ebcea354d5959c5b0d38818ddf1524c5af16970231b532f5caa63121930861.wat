(module
  ...
  (elem (;0;) (i32.const 1) func 151 155 154 160 55 160 156)
  ...
  (func (;37;) (type 28) (param i32 i64 i32 i32)
    local.get 0
    call 39
    local.get 1
    local.get 2
  ...
  (func (;47;) (type 29) (param i32 i32 i32 i32) (result i64)
    local.get 1
    local.get 3
    i32.ne
    if ;; label = @1
  ...
  (func (;157;) (type 3) (param i32 i64 i64 i64 i64)
  ...
  (func (;164;) (type 43) (param i32 i64 i64 i64 i64 i32)
    (local i32 i32 i64 i64)
    global.get 0
    i32.const 96
    i32.sub
  ...
  (func (;165;) (type 3) (param i32 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
