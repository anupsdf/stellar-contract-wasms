(module
  ...
  (export "set_total_supply" (func 33))
  (export "total_supply" (func 37))
  (export "set_privileged_addrs" (func 40))
  (export "get_privileged_addrs" (func 44))
  (export "commit_transfer_ownership" (func 46))
  (export "apply_transfer_ownership" (func 50))
  (export "revert_transfer_ownership" (func 51))
  (export "get_future_address" (func 53))
  (export "version" (func 58))
  (export "commit_upgrade" (func 59))
  ...
  (func (;78;) (type 10))
  (data (;0;) (i32.const 1048576) "TotalSupplycommit_transfer_ownershipapply_transfer_ownershiprevert_transfer_ownershipset_privileged_addrsdisable_emergency_modeenable_emergency_modeAdminEmergencyAdminRewardsAdminOperationsAdminPauseAdminEmergencyPauseAdminOperatorEmPauseAdminsFutureAdminFutureEmergencyAdminTransferOwnershipDeadlineEmAdminTransferOwnershipDeadlineEmergencyModecommit_upgradeapply_upgraderevert_upgradeUpgradeDeadlineFutureWASM")
