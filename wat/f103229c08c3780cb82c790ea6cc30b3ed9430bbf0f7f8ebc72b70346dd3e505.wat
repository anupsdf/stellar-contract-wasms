(module
  ...
  (elem (;0;) (i32.const 1) func 77 76 49 78)
  ...
  (func (;74;) (type 20) (param i32 i32 i32 i32) (result i32)
    (local i32)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
  ...
  (func (;89;) (type 18) (param i32 i64 i64 i64 i64)
