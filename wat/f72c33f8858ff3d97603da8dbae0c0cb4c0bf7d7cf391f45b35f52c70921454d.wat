(module
  ...
  (export "init" (func 61))
  (export "mint" (func 62))
  (export "add_liquidity_invoke" (func 65))
  ...
  (func (;50;) (type 18) (param i64 i64 i64 i64 i32)
    (local i32 i32)
    global.get 0
    i32.const 80
    i32.sub
  ...
  (func (;65;) (type 0) (param i64 i64 i64 i64) (result i64)
    (local i32 i64 i64 i32 i64 i64 i64 i64 i64 i64 i64 i64 i64 i64 i64 i64 i64 i64 i32)
    global.get 0
    i32.const 320
    i32.sub
    local.tee 4
  ...
  (func (;86;) (type 22) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      block ;; label = @2
        local.get 3
  ...
  (func (;87;) (type 23) (param i32 i64 i64 i64 i64)
  ...
  (func (;89;) (type 24) (param i32 i64 i64 i64 i64 i32)
