(module
  ...
  (export "upgrade_contract" (func 44))
  (export "handle_upgrade_contract" (func 46))
  (export "upgrade_contract_completed" (func 47))
  (export "__constructor" (func 49))
  (export "deploy" (func 50))
  (export "remove_deployed_contract" (func 52))
  (export "deployed_contract_for" (func 53))
  (export "total_deployed_contracts" (func 54))
  (export "admin" (func 55))
  (export "set_admin" (func 56))
  (export "loyalty_token_wasm_hash" (func 57))
  (export "set_loyalty_token_wasm_hash" (func 58))
  (export "set_invitations_enabled" (func 59))
  (export "invitations_enabled" (func 60))
  (export "request_invitation" (func 61))
  (export "approve_invitation" (func 62))
  (export "invitation_approved" (func 63))
  (export "_" (func 65))
  ...
  (func (;21;) (type 13) (param i64 i64 i64 i64)
    local.get 0
    local.get 1
    call 20
    local.get 2
  ...
  (func (;22;) (type 14) (param i64 i64 i32 i64)
    local.get 0
    local.get 1
    call 20
    local.get 2
