(module
  ...
  (export "update_signer" (func 97))
  (export "remove_signer" (func 98))
  (export "update_contract_code" (func 99))
  ...
  (func (;102;) (type 32) (param i64 i32 i32)
    local.get 0
    i64.const 4
    local.get 1
    i64.extend_i32_u
  ...
  (func (;103;) (type 11) (param i32 i32 i32 i32)
    (local i32 i32 i32 i32)
    block ;; label = @1
      block ;; label = @2
        local.get 1
  ...
  (func (;106;) (type 16))
  (func (;107;) (type 13) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    block ;; label = @1
      local.get 2
      i32.eqz
  ...
  (func (;109;) (type 13) (param i32 i32 i32) (result i32)
  ...
  (@custom "contractmetav0" (after data) "\00\00\00\00\00\00\00\05rsver\00\00\00\00\00\00\061.85.1\00\00\00\00\00\00\00\00\00\08rssdkver\00\00\00/22.0.7#211569aa49c8d896877dfca1f2eb4fe9071121c8\00")
)
