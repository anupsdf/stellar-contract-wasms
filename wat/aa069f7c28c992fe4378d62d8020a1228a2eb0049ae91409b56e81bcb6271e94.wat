(module
  ...
  (export "mint" (func 31))
  (export "add_minter" (func 34))
  (export "remove_minter" (func 35))
  (export "burn" (func 36))
  (export "transfer_from" (func 37))
  (export "owner_of" (func 38))
  (export "set_base_uri" (func 39))
  (export "get_base_uri" (func 40))
  (export "get_token_uri" (func 42))
  (export "_" (func 44))
  ...
  (func (;32;) (type 14) (param i64 i64 i64) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 48
    i32.sub
